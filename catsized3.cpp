...
while (answer =='y') {
	...
	//printing Hippo line
	cout << setfill(' ') << setw(1) << "|" << setw(15) << left << "Cat" << setw(1) << "|" << setw(15) << left << "10 Kg" << setw(1) << "|"  << setw(5) << left << " " << setw(1) << "|" << endl;
	cout << setfill('-') << setw(1) << "+" << setw(15) << "-" << setw(1) << "+" << setw(15) << "-" << setw(1) << "+" << setw(5) << "-" << setw(1) << "+" << endl;
...
numHippos = userInput/10;

cout<<"Your object is as heavy as about "<<numHippos<<" Cats COMBINED!" << endl << "Would u like to sizeUp something else (y/n?)"<<endl;
cin>>answer;
